...
-- output('** Generated automatically by '..TOLUA_VERSION..' on '..date()..'.\n')
 ...
 output('extern "C" TOLUA_API int tolua_bnd_takeownership (lua_State* L); // from tolua_map.c\n')
	output('#else\n')
 output('TOLUA_API int tolua_bnd_takeownership (lua_State* L); /* from tolua_map.c */\n')
	output('#endif\n')
